...
export function CustomCursor() {
  ...
  return (
    <>
      ...
      >
        <motion.div
          animate={{ scale: hover ? 0.4 : 1, opacity: hover ? 0.6 : 0.4 }}
          className="h-9 w-9 rounded-full border border-[oklch(0.88_0.10_90)/40]"
          style={{ borderColor: "oklch(0.88 0.10 90 / 0.4)" }}
        />
      </motion.div>
    </>
  );
